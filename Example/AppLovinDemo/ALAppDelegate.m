...
static NSString *const YOUR_SDK_KEY = @"EuRmGOTtSXTgK_H0PU84px1Ht14S3RPTGXvDm_yRlV2Bf2eMQuM_pGCRTvQTz4AZTJMqxMe5TcCDfTms6f3ZTs";
...
//        }
    ...
    [[ALSdk shared] initializeWithConfiguration: initConfig completionHandler:^(ALSdkConfiguration *sdkConfig) {
        NSLog(@"ALSdkConfiguration: %@",sdkConfig);
